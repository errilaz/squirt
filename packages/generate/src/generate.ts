...
async function writeHtml() {
  ...
  return Promise.all([
    Bun.write("src/generated/html.types.d.ts", types),
    Bun.write("src/generated/html.define.ts", define),
  ])
}
...
async function writeCss() {
  ...
  return Promise.all([
    Bun.write("src/generated/css.types.d.ts", types),
    Bun.write("src/generated/css.define.ts", define),
  ])
}
    ...
    if (property.values.length > 0) {
      ...
      for (const value of property.values) {
        if (value.type === "keyword") {
          ...
          types += `    const ${value.jsName}: Property\n`
